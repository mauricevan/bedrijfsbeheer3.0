...
- **Performance-first development** - Code wordt altijd geoptimaliseerd voor maximale efficiëntie
- **Code reusability** - Evalueer altijd of code hergebruikt kan worden (DRY principe)

#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('c:\\Users\\hp\\.cursor\\extensions\\wallabyjs.console-ninja-1.0.493-universal\\out\\buildHook\\index.js').default({tool: 'vite', checkSum: '2048f422425228881f1beaARZSGgADDgNQAAQLC1oIXgVSAwUE', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///c:/Users/hp/.cursor/extensions/wallabyjs.console-ninja-1.0.493-universal/out/buildHook/index.js').then(m => m.default.default({tool: 'vite', checkSum: '2048f422425228881f1beaARZSGgADDgNQAAQLC1oIXgVSAwUE', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
